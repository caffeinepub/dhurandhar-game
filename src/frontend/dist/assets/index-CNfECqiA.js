...
function GameCanvas() {
  ...
  function render(ctx, vw, vh, s, imgs) {
    ...
    const cityImgW = (cityImg == null ? void 0 : cityImg.naturalWidth) > 0 ? cityImg.naturalWidth : 1920;
    ...
    const groundImgW = (groundImg == null ? void 0 : groundImg.naturalWidth) > 0 ? groundImg.naturalWidth : 1920;
  ...
  function drawFallbackCity(ctx, vw, vh, camX) {
  ...
  function drawParkedCars(ctx, vw, vh) {
    const groundY = vh * GROUND_Y_RATIO;
