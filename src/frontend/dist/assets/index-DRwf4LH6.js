...
function ParentDashboard({
  ...
  if (!unlocked) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-3xl p-8 w-full max-w-sm shadow-card-hover", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-muted-foreground mb-6 font-semibold", children: lang === "en" ? "Enter PIN to continue" : "जारी रखने के लिए PIN दर्ज करें" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center gap-3 mb-6", children: [0, 1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: `w-12 h-12 rounded-xl border-2 flex items-center justify-center text-2xl font-black transition-colors ${error ? "border-destructive bg-red-50" : "border-border bg-muted"}`,
          ...
          error && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: lang === "en" ? "Wrong PIN! Try again." : "गलत PIN! फिर कोशिश करें।"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3", children: ["1", "2", "3", "4", "5", "6", "7", "8", "9", "⌫", "0", "✓"].map(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-3xl p-6 w-full max-w-lg shadow-card-hover my-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-2xl font-black", style: { color: "#F36C2F" }, children: [
            "👨‍👩‍👧 ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: CLASSES.map((cls) => {
          const cp = progress[cls.id];
          const totalStars = cp ? Object.values(cp).reduce((s, v) => s + v.stars, 0) : 0;
          const classSubjects = cls.subjects.map((id) => ALL_SUBJECTS.find((s) => s.id === id)).filter(Boolean);
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2", children: classSubjects.map((sub) => {
                  if (!sub) return null;
                  const sp = cp == null ? void 0 : cp[sub.id];
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      className: "text-center p-2 rounded-xl bg-muted",
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xl", children: sub.emoji }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold text-muted-foreground", children: lang === "en" ? sub.label : sub.labelHi }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "div",
                          {
                            ...
                            children: [
                              "⭐ ",
                              (sp == null ? void 0 : sp.stars) ?? 0
                            ]
                          }
                        ),
                        (sp == null ? void 0 : sp.completed) && /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
                          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 flex gap-3", children: confirmReset ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              ...
              children: lang === "en" ? "Yes, Reset All" : "हाँ, सब रीसेट करें"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: lang === "en" ? "Cancel" : "रद्द करें"
            }
          )
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              "🗑️ ",
              lang === "en" ? "Reset All Progress" : "सारी प्रगति रीसेट करें"
            ]
          }
        ) })
      ] })
...
function StarAnimation({ trigger }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none fixed inset-0 z-50 overflow-hidden", children: stars.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
...
function speakSpelling(word, callback) {
  ...
  const speakNext = () => {
    if (i < letters.length) {
      ...
      setTimeout(() => {
        ...
        utter.lang = "en-US";
        utter.rate = 0.85;
        utter.onend = () => callback == null ? void 0 : callback();
        window.speechSynthesis.speak(utter);
      }, 300);
    }
  };
...
function speakRhymeLine(line, lang = "en") {
  speakText(line, lang);
}
function AlphabetGame({
  ...
  const [quizOptions, setQuizOptions] = reactExports.useState([]);
  const item = ALPHABET[index2];
  const generateOptions = reactExports.useCallback(
    (idx) => {
      const correct = lang === "en" ? ALPHABET[idx].word : ALPHABET[idx].wordHi;
      const pool = ALPHABET.filter((_, i) => i !== idx).map(
        (a) => lang === "en" ? a.word : a.wordHi
      );
  ...
  const prev = () => {
    const ni = (index2 - 1 + ALPHABET.length) % ALPHABET.length;
    setIndex(ni);
    setQuizMode(false);
    setSelectedOption(null);
  };
  const next = () => {
    const ni = (index2 + 1) % ALPHABET.length;
    setIndex(ni);
    setQuizMode(false);
    setSelectedOption(null);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-xs bg-white rounded-3xl shadow-card p-8 flex flex-col items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: lang === "en" ? item.letter : item.letterHi
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-8xl", children: item.emoji }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold text-foreground", children: lang === "en" ? item.word : item.wordHi }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground", children: lang === "en" ? `Letter ${index2 + 1} of 26` : `अक्षर ${index2 + 1} / 26` })
        ] }),
        quizMode ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "w-full max-w-xs flex flex-col gap-3",
            "data-ocid": "alphabet.quiz.panel",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center font-bold text-lg text-foreground", children: [
                lang === "en" ? "What word starts with" : "कौन सा शब्द शुरू होता है",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#F36C2F" }, children: lang === "en" ? item.letter : item.letterHi }),
                "?"
              ] }),
              quizOptions.map((opt, i) => {
                ...
                if (selectedOption === opt) {
                  bg = opt === correct ? "bg-kids-green border-kids-green text-white" : "bg-destructive border-destructive text-white";
          ...
          "button",
          {
            ...
            children: lang === "en" ? "Quiz Me! 🎯" : "क्विज़ खेलें! 🎯"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 mt-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1", children: ALPHABET.slice(0, 13).map((letter) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "w-2 h-2 rounded-full transition-colors",
              style: {
                backgroundColor: ALPHABET.indexOf(letter) === index2 ? "#F36C2F" : "#D0E4F0"
              }
            },
            letter.letter
          )) }),
...
function getOptions$5(lang, correctIdx) {
  const correct = lang === "en" ? ANIMALS[correctIdx].name : ANIMALS[correctIdx].nameHi;
  const pool = ANIMALS.filter((_, i) => i !== correctIdx).map(
    (a) => lang === "en" ? a.name : a.nameHi
  );
  const wrong = pool.sort(() => Math.random() - 0.5).slice(0, 3);
  return [correct, ...wrong].sort(() => Math.random() - 0.5);
}
function AnimalsGame({ lang, onAnswer }) {
  const [index2, setIndex] = reactExports.useState(0);
  const [selected, setSelected] = reactExports.useState(null);
  const [opts, setOpts] = reactExports.useState(() => getOptions$5(lang, 0));
  const item = ANIMALS[index2];
  ...
  const handleSelect = reactExports.useCallback(
    (opt) => {
      ...
      setTimeout(() => {
        const ni = (index2 + 1) % ANIMALS.length;
        setIndex(ni);
        setSelected(null);
        setOpts(getOptions$5(lang, ni));
      }, 1200);
    },
    [selected, correct, index2, lang, onAnswer]
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-xs bg-white rounded-3xl shadow-card p-8 flex flex-col items-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-9xl", children: item.emoji }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-lg text-muted-foreground", children: lang === "en" ? "What animal is this?" : "यह कौन सा जानवर है?" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3 w-full max-w-xs", children: opts.map((opt, i) => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground", children: lang === "en" ? `Animal ${index2 + 1} of ${ANIMALS.length}` : `जानवर ${index2 + 1} / ${ANIMALS.length}` })
      ]
    }
  );
}
function getOptions$4(lang, correctIdx) {
  const correct = lang === "en" ? BODY_PARTS[correctIdx].name : BODY_PARTS[correctIdx].nameHi;
  const pool = BODY_PARTS.filter((_, i) => i !== correctIdx).map(
    (b) => lang === "en" ? b.name : b.nameHi
  );
  const wrong = pool.sort(() => Math.random() - 0.5).slice(0, 3);
  return [correct, ...wrong].sort(() => Math.random() - 0.5);
}
function BodyPartsGame({ lang, onAnswer }) {
  const [index2, setIndex] = reactExports.useState(0);
  const [selected, setSelected] = reactExports.useState(null);
  const [opts, setOpts] = reactExports.useState(() => getOptions$4(lang, 0));
  const item = BODY_PARTS[index2];
  const correct = lang === "en" ? item.name : item.nameHi;
  const handleSelect = reactExports.useCallback(
    (opt) => {
      if (selected) return;
      ...
      setTimeout(() => {
        const ni = (index2 + 1) % BODY_PARTS.length;
        setIndex(ni);
        setSelected(null);
        setOpts(getOptions$4(lang, ni));
      }, 1200);
    },
    [selected, correct, index2, lang, onAnswer, item.name]
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-xs bg-white rounded-3xl shadow-card p-8 flex flex-col items-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-9xl", children: item.emoji }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-lg text-muted-foreground", children: lang === "en" ? "Which body part is this?" : "यह कौन सा शरीर का अंग है?" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3 w-full max-w-xs", children: opts.map((opt, i) => {
          let cls = "bg-white border-2 border-border text-foreground";
          if (selected) {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground", children: lang === "en" ? `Part ${index2 + 1} of ${BODY_PARTS.length}` : `अंग ${index2 + 1} / ${BODY_PARTS.length}` })
      ]
    }
  );
}
function getOptions$3(lang, correctIdx) {
  const correct = lang === "en" ? COLORS[correctIdx].name : COLORS[correctIdx].nameHi;
  const pool = COLORS.filter((_, i) => i !== correctIdx).map(
    (c) => lang === "en" ? c.name : c.nameHi
  );
  const wrong = pool.sort(() => Math.random() - 0.5).slice(0, 3);
  return [correct, ...wrong].sort(() => Math.random() - 0.5);
}
function ColorsGame({ lang, onAnswer }) {
  const [index2, setIndex] = reactExports.useState(0);
  const [selected, setSelected] = reactExports.useState(null);
  const [opts, setOpts] = reactExports.useState(() => getOptions$3(lang, 0));
  const item = COLORS[index2];
  const correct = lang === "en" ? item.name : item.nameHi;
  const handleSelect = reactExports.useCallback(
    (opt) => {
      if (selected) return;
      ...
      if (isCorrect) speakWord(item.name, "en");
      setTimeout(() => {
        const ni = (index2 + 1) % COLORS.length;
        setIndex(ni);
        setSelected(null);
        setOpts(getOptions$3(lang, ni));
      }, 1200);
    },
    [selected, correct, index2, lang, onAnswer, item.name]
  );
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-xs bg-white rounded-3xl shadow-card p-8 flex flex-col items-center gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl", children: item.emoji }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-lg text-muted-foreground", children: lang === "en" ? "What color is this?" : "यह कौन सा रंग है?" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3 w-full max-w-xs", children: opts.map((opt, i) => {
          let cls = "bg-white border-2 border-border text-foreground";
          if (selected) {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground", children: lang === "en" ? `Color ${index2 + 1} of ${COLORS.length}` : `रंग ${index2 + 1} / ${COLORS.length}` })
      ]
    }
  );
}
function getOptions$2(lang, correctIdx) {
  const correct = lang === "en" ? FRUITS[correctIdx].name : FRUITS[correctIdx].nameHi;
  const pool = FRUITS.filter((_, i) => i !== correctIdx).map(
    (f) => lang === "en" ? f.name : f.nameHi
  );
  const wrong = pool.sort(() => Math.random() - 0.5).slice(0, 3);
  return [correct, ...wrong].sort(() => Math.random() - 0.5);
}
function FruitsGame({ lang, onAnswer }) {
  const [index2, setIndex] = reactExports.useState(0);
  const [selected, setSelected] = reactExports.useState(null);
  const [opts, setOpts] = reactExports.useState(() => getOptions$2(lang, 0));
  const item = FRUITS[index2];
  const correct = lang === "en" ? item.name : item.nameHi;
  const handleSelect = reactExports.useCallback(
    (opt) => {
      if (selected) return;
      ...
      if (isCorrect) speakWord(item.name, "en");
      setTimeout(() => {
        const ni = (index2 + 1) % FRUITS.length;
        setIndex(ni);
        setSelected(null);
        setOpts(getOptions$2(lang, ni));
      }, 1200);
    },
    [selected, correct, index2, lang, onAnswer, item.name]
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-xs bg-white rounded-3xl shadow-card p-8 flex flex-col items-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-9xl", children: item.emoji }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-lg text-muted-foreground", children: lang === "en" ? "What fruit is this?" : "यह कौन सा फल है?" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3 w-full max-w-xs", children: opts.map((opt, i) => {
          let cls = "bg-white border-2 border-border text-foreground";
          if (selected) {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground", children: lang === "en" ? `Fruit ${index2 + 1} of ${FRUITS.length}` : `फल ${index2 + 1} / ${FRUITS.length}` })
      ]
    }
  );
}
function getOptions$1(correct) {
  const opts = /* @__PURE__ */ new Set([correct]);
  while (opts.size < 3) {
...
function StarRow({
  ...
  for (let n = 1; n <= count; n++) {
    items.push(
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: dim ? "opacity-30" : "", children: n % 2 === 0 ? "🌟" : "⭐" }, `${prefix2}-${n}`)
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: items });
}
function MathGame({ lang, onAnswer, problems }) {
  const pool = problems ?? MATH_PROBLEMS;
  const [index2, setIndex] = reactExports.useState(0);
  const [selected, setSelected] = reactExports.useState(null);
  const problem = pool[index2 % pool.length];
  const correct = problem.op === "+" ? problem.a + problem.b : problem.op === "-" ? problem.a - problem.b : problem.a * problem.b;
  const [opts, setOpts] = reactExports.useState(() => getOptions$1(correct));
  const handleSelect = reactExports.useCallback(
    (opt) => {
      ...
      onAnswer(opt === correct);
      setTimeout(() => {
        const ni = (index2 + 1) % pool.length;
        setIndex(ni);
        setSelected(null);
        const newP = pool[ni % pool.length];
        const newCorrect = newP.op === "+" ? newP.a + newP.b : newP.op === "-" ? newP.a - newP.b : newP.a * newP.b;
        setOpts(getOptions$1(newCorrect));
      }, 1200);
    },
    [selected, correct, index2, pool, onAnswer]
  );
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-xs bg-white rounded-3xl shadow-card p-8 flex flex-col items-center gap-4", children: [
          ...
          showVisual && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-2xl", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(StarRow, { count: aCount, prefix: "a" }),
            problem.op === "+" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              " ",
              "+ ",
              /* @__PURE__ */ jsxRuntimeExports.jsx(StarRow, { count: bCount, prefix: "b" })
            ] }),
            problem.op === "-" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              " ",
              "- ",
              /* @__PURE__ */ jsxRuntimeExports.jsx(StarRow, { count: bCount, dim: true, prefix: "b" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-semibold", children: lang === "en" ? "What is the answer?" : "जवाब क्या है?" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-4", children: opts.map((opt, i) => {
          let cls = "bg-white border-2 border-border text-foreground";
          if (selected !== null) {
            if (opt === correct)
              cls = "bg-kids-green border-kids-green text-white";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground", children: lang === "en" ? `Problem ${index2 % pool.length + 1} of ${pool.length}` : `प्रश्न ${index2 % pool.length + 1} / ${pool.length}` })
      ]
    }
  );
}
function NumbersGame({ lang, onAnswer }) {
  const [index2, setIndex] = reactExports.useState(0);
  const [selected, setSelected] = reactExports.useState(null);
  const item = NUMBERS[index2];
  const correct = item.num;
  const genOptions = (num) => {
    const opts2 = /* @__PURE__ */ new Set([num]);
    while (opts2.size < 3) {
      const r = Math.max(1, num + Math.floor(Math.random() * 5) - 2);
      if (r !== num && r >= 1 && r <= 20) opts2.add(r);
    }
    return [...opts2].sort(() => Math.random() - 0.5);
  };
  const [options] = reactExports.useState(() => genOptions(correct));
  const [opts, setOpts] = reactExports.useState(options);
  const handleSelect = (opt) => {
    if (selected !== null) return;
    setSelected(opt);
    onAnswer(opt === correct);
    setTimeout(() => {
      const ni = (index2 + 1) % NUMBERS.length;
      setIndex(ni);
      setSelected(null);
      setOpts(genOptions(NUMBERS[ni].num));
    }, 1200);
  };
  const displayEmoji = item.num <= 10 ? item.emojis : `${item.emojis.split("x")[0]} × ${item.num}`;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "flex flex-col items-center gap-6 py-4",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-xs bg-white rounded-3xl shadow-card p-6 flex flex-col items-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl text-center leading-snug min-h-[4rem]", children: displayEmoji }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xl font-bold text-foreground", children: lang === "en" ? item.wordEn : item.wordHi })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-lg text-foreground", children: lang === "en" ? "How many? 🤔" : "कितने हैं? 🤔" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3", children: opts.map((opt, i) => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground", children: lang === "en" ? `Number ${index2 + 1} of 20` : `संख्या ${index2 + 1} / 20` })
      ]
    }
  );
}
function RhymesGame({ lang, onAnswer }) {
  const [rhymeIndex, setRhymeIndex] = reactExports.useState(0);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 flex-wrap justify-center", children: NURSERY_RHYMES.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            onClick: () => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-5xl", children: rhyme.emoji }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-black", style: { color: "#F36C2F" }, children: lang === "en" ? rhyme.title : rhyme.titleHi }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full flex flex-col gap-1 mt-2", children: lines.map((line, i) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    style: {
                      background: i === currentLine && playing ? "#FDE8D8" : "transparent",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: playing ? "▶ Playing..." : "▶ Play Rhyme 🎵"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: lang === "en" ? "Tap any line to hear it, or press Play to hear the full rhyme" : "किसी भी लाइन पर टैप करें या पूरी कविता सुनने के लिए Play दबाएं" })
      ]
    }
  );
}
function getOptions(lang, correctIdx) {
  const correct = lang === "en" ? SHAPES[correctIdx].name : SHAPES[correctIdx].nameHi;
  const pool = SHAPES.filter((_, i) => i !== correctIdx).map(
    (s) => lang === "en" ? s.name : s.nameHi
  );
  const wrong = pool.sort(() => Math.random() - 0.5).slice(0, 2);
  return [correct, ...wrong].sort(() => Math.random() - 0.5);
}
function ShapesGame({ lang, onAnswer }) {
  const [index2, setIndex] = reactExports.useState(0);
  const [selected, setSelected] = reactExports.useState(null);
  const [opts, setOpts] = reactExports.useState(() => getOptions(lang, 0));
  const item = SHAPES[index2];
  const correct = lang === "en" ? item.name : item.nameHi;
  const handleSelect = reactExports.useCallback(
    (opt) => {
      if (selected) return;
      ...
      onAnswer(opt === correct);
      setTimeout(() => {
        const ni = (index2 + 1) % SHAPES.length;
        setIndex(ni);
        setSelected(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-xs bg-white rounded-3xl shadow-card p-8 flex flex-col items-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-9xl", children: item.emoji }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-lg text-muted-foreground", children: lang === "en" ? "What shape is this?" : "यह कौन सा आकार है?" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3 w-full max-w-xs", children: opts.map((opt, i) => {
          let cls = "bg-white border-2 border-border text-foreground";
          if (selected) {
            if (opt === correct)
              cls = "bg-kids-green border-kids-green text-white";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground", children: lang === "en" ? `Shape ${index2 + 1} of ${SHAPES.length}` : `आकार ${index2 + 1} / ${SHAPES.length}` })
      ]
    }
  );
}
function getLetterOptions(correct) {
  const alphabet2 = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
  const opts = /* @__PURE__ */ new Set([correct]);
  while (opts.size < 4) {
    const r = alphabet2[Math.floor(Math.random() * alphabet2.length)];
    if (r !== correct) opts.add(r);
  }
  return [...opts].sort(() => Math.random() - 0.5);
}
function SpellingGame({
  ...
  const [index2, setIndex] = reactExports.useState(0);
  const [selected, setSelected] = reactExports.useState(null);
  const [spellingDone, setSpellingDone] = reactExports.useState(false);
  const item = words[index2 % words.length];
  ...
  const displayWord = item.word.split("").map((ch, i) => i === item.missingIndex ? "_" : ch).join(" ");
  const handleSelect = reactExports.useCallback(
    (opt) => {
      if (selected) return;
      setSelected(opt);
      ...
      setTimeout(() => {
        const ni = (index2 + 1) % words.length;
        setIndex(ni);
        setSelected(null);
        setSpellingDone(false);
    ...
    [selected, correctLetter, index2, words, onAnswer, item.word]
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-xs bg-white rounded-3xl shadow-card p-8 flex flex-col items-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-8xl", children: item.emoji }),
          spellingDone ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
          ...
          spellingDone && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-bold", style: { color: "#22C55E" }, children: [
            "🔊 ",
            lang === "en" ? "Listen to the spelling!" : "वर्तनी सुनें!"
          ] }),
          !spellingDone && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-semibold text-sm", children: lang === "en" ? "Fill in the missing letter!" : "खाली जगह भरें!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-3 w-full max-w-xs", children: opts.map((opt, i) => {
          let cls = "bg-white border-2 border-border text-foreground";
          if (selected) {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground", children: lang === "en" ? `Word ${index2 % words.length + 1} of ${words.length}` : `शब्द ${index2 % words.length + 1} / ${words.length}` })
      ]
    }
  );
}
...
function useProgress() {
  ...
  const saveProgress = reactExports.useCallback((updated) => {
    setProgress(updated);
    try {
  ...
  const getSubjectProgress = reactExports.useCallback(
    (classId, subject) => {
      var _a2;
      return ((_a2 = progress[classId]) == null ? void 0 : _a2[subject]) ?? defaultSubject();
    },
    [progress]
  );
  const addStar = reactExports.useCallback(
    (classId, subject, isCorrect) => {
      var _a2;
      const current = ((_a2 = progress[classId]) == null ? void 0 : _a2[subject]) ?? defaultSubject();
      const updated = {
        ...progress,
        [classId]: {
          ...progress[classId],
  ...
  const getTotalStars = reactExports.useCallback(
    (classId) => {
...
function App() {
  ...
  const [showParent, setShowParent] = reactExports.useState(false);
  const [starTrigger, setStarTrigger] = reactExports.useState(0);
  ...
  const spellingLevel = (currentClassDef == null ? void 0 : currentClassDef.spellingLevel) ?? 0;
  const renderGame = () => {
    const props = { lang, onAnswer: handleAnswer, classId: selectedClass };
    switch (selectedSubject) {
      case "rhymes":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(RhymesGame, { lang, onAnswer: handleAnswer });
      case "alphabet":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(AlphabetGame, { ...props });
      case "numbers":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(NumbersGame, { lang, onAnswer: handleAnswer });
      case "shapes":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ShapesGame, { lang, onAnswer: handleAnswer });
      case "colors":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ColorsGame, { lang, onAnswer: handleAnswer });
      case "animals":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(AnimalsGame, { lang, onAnswer: handleAnswer });
      case "fruits":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(FruitsGame, { lang, onAnswer: handleAnswer });
      case "bodyparts":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(BodyPartsGame, { lang, onAnswer: handleAnswer });
      case "math":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(MathGame, { lang, onAnswer: handleAnswer, problems: void 0 });
      case "math3":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          MathGame,
          {
  ...
  const classSubjects = currentClassDef ? currentClassDef.subjects.map((id) => ALL_SUBJECTS.find((s) => s.id === id)).filter(Boolean) : [];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "min-h-screen",
      style: {
        background: "linear-gradient(135deg, #FFF8F0 0%, #E8F9FB 50%, #FFFBEA 100%)",
      ...
      children: [
          ...
          "header",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-black text-xl", style: { color: "#F36C2F" }, children: "KidsLearn" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "max-w-lg mx-auto px-4 py-6", children: [
          screen === "home" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-6xl mb-2", children: "🦁" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-black", style: { color: "#F36C2F" }, children: lang === "en" ? "KidsLearn" : "बच्चों की पढ़ाई" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-semibold mt-1", children: lang === "en" ? "Nursery to Class 4 • English & Hindi" : "नर्सरी से कक्षा 4 • अंग्रेजी और हिंदी" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full grid grid-cols-2 gap-3", children: CLASSES.map((cls) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-4xl", children: cls.emoji }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg", children: lang === "en" ? cls.label : cls.labelHi }),
                    stars > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-black", children: [
                      "⭐ ",
                      stars
                    ] })
                  ]
          ...
          screen === "class" && currentClassDef && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-1", children: currentClassDef.emoji }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h2",
                {
                  className: "text-2xl font-black",
                  style: { color: currentClassDef.color },
                  children: lang === "en" ? currentClassDef.label : currentClassDef.labelHi
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-semibold", children: lang === "en" ? "Choose a subject" : "विषय चुनें" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: classSubjects.map((sub) => {
              var _a2;
              if (!sub) return null;
              const sp = (_a2 = progress[selectedClass]) == null ? void 0 : _a2[sub.id];
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-4xl", children: sub.emoji }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        className: "text-base font-black",
                        style: { color: sub.color },
                        children: lang === "en" ? sub.label : sub.labelHi
                      }
                    ),
                    sp && sp.stars > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-bold text-amber-500", children: [
                      "⭐ ",
                      sp.stars
                    ] }),
                    (sp == null ? void 0 : sp.completed) && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "🏆" })
                  ]
                },
                sub.id
              );
          ...
          screen === "game" && currentClassDef && currentSubjectDef && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
                ...
                children: [
                  ...
                  " ",
                  lang === "en" ? currentSubjectDef.label : currentSubjectDef.labelHi
                ]
              }
            ) }),
            renderGame()
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(StarAnimation, { trigger: starTrigger }),
        showParent && /* @__PURE__ */ jsxRuntimeExports.jsx(
          ParentDashboard,
          {
            lang,
            progress,
